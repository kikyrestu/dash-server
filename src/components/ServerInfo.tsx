          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <div className="text-white font-medium">{serverInfo.totalMemory || 'N/A'}</div>
              </div>
              <div>
                <label className="text-sm text-slate-400">Used Memory</label>
                <div className="text-white font-medium">{serverInfo.usedMemory || 'N/A'}</div>
              </div>
              <div>
                <label className="text-sm text-slate-400">Free Memory</label>
                <div className="text-white font-medium">{serverInfo.freeMemory || 'N/A'}</div>
              </div>
            </div>
            <div>
